"""LSTM Flipout Layer adapted for Alpha Divergence."""

import math

import torch
from bayesian_torch.layers.variational_layers.rnn_flipout import *
from torch import Tensor

from .variational_layers.linear_flipout import LinearFlipout


class LSTMFlipout(LSTMFlipout):
    """LSTM Flipout Layers adapted for Alpha Divergence."""
    ...
    def __init__(
        ...
        """
        Implement LSTM layer with Flipout reparameterization trick.

        Inherits from bayesian_torch.layers.variational_layers.rnn_flipout,
        LSTMFlipout.
