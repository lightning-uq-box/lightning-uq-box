...
class TestBaseEnsembleModel:
    ...
    def ensemble_model(
        ...
        conf = OmegaConf.load(
            os.path.join("tests", "configs", "deep_ensemble", request.param)
        )
        ...
        return DeepEnsembleRegression(n_ensemble_members, ensemble_members)

    def test_ensemble_forward(self, ensemble_model: DeepEnsembleRegression) -> None:
    ...
    def test_ensemble_trainer_test(
        self, ensemble_model: DeepEnsembleRegression
    ) -> None:
